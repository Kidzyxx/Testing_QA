...
def create_test_cart(cart_id):
    cart = Cart(id=cart_id, coupon_code='SAMPLE_COUPON', shipping_fee=10000, subtotal=50000, grand_total=60000)
    cart_item = CartItem(product_id=1, qty=1, item_price=25000)
